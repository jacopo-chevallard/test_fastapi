...
[![codecov](https://codecov.io/gh/jacopo-chevallard/test_fastapi/branch/main/graph/badge.svg?token=test_fastapi_token_here)](https://codecov.io/gh/jacopo-chevallard/test_fastapi)
[![CI](https://github.com/jacopo-chevallard/test_fastapi/actions/workflows/main.yml/badge.svg)](https://github.com/jacopo-chevallard/test_fastapi/actions/workflows/main.yml)

Awesome test_fastapi created by jacopo-chevallard

## Install

from source
```bash
git clone https://github.com/jacopo-chevallard/test_fastapi test_fastapi
cd test_fastapi
make install
```
